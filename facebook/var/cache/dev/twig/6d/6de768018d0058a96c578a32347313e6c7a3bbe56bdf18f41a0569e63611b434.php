...
class __TwigTemplate_5bd9e33542650c8abb57e936d9f2c2f7ff0ac6fe608936c2c2ee06575e3c9412 extends Twig_Template
{
    ...
    <table>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 14
        echo twig_escape_filter($this->env, $this->getAttribute(($context["utilisateur"] ?? $this->getContext($context, "utilisateur")), "password", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Nom</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 26
        echo twig_escape_filter($this->env, $this->getAttribute(($context["utilisateur"] ?? $this->getContext($context, "utilisateur")), "ppPath", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Bio</th>
                <td>";
        // line 30
        echo twig_escape_filter($this->env, $this->getAttribute(($context["utilisateur"] ?? $this->getContext($context, "utilisateur")), "bio", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Id</th>
    ...
    <ul>
        <li>
            <a href=\"";
        // line 41
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("utilisateur_admin_index");
...
{% block body %}
    ...
    <ul>
        <li>
            <a href=\"{{ path('utilisateur_admin_index') }}\">Back to the list</a>
        </li>
    </ul>
{% endblock %}
", "utilisateur/show.html.twig", "C:\\Users\\kevin\\Desktop\\projet Symfony\\projet_v1_27_04-new_profile_page\\facebook\\app\\Resources\\views\\utilisateur\\show.html.twig");
    }
}
